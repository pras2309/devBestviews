...
extract(shortcode_atts(array(
	'title'            => esc_html__( 'Column title', 'gauge-plugin' ), 
	'highlight'        => 'disabled',
	'highlight_text' => '',
	'price'            => '',
	'currency_symbol'  => '',
...
if ( $border == 'enabled' ) {
	$gp_border_class = 'gp-price-column-border';
} else {
	$gp_border_class = '';
}
...
<div class="gp-pricing-column <?php echo sanitize_html_class( $gp_border_class ); ?>" style="background-color: <?php echo esc_attr( $gp_bg_color ); ?>; border-color: <?php echo esc_attr( $border_color ); ?>; color: <?php echo esc_attr( $text_color ); ?>;">
	...
	<div class="gp-pricing-column-inner">
		...
		<div class="gp-pricing-column-content" style="border-color: <?php echo esc_attr( $border_color ); ?>;"><?php echo do_shortcode( wpb_js_remove_wpautop( $content, true ) ); ?></div>
