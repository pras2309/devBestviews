				...
				<div id="poststuff">
					...
					<form action="themes.php?page=sidebars" method="post">
						...
						<div id="namediv" class="stuffbox">
							<h3><label for="sidebar_name"><?php esc_html_e( 'ID', 'gauge' ); ?></label></h3>
							<div class="inside">
						...
						<p class="submit"><input type="submit" class="button-primary" name="update-sidebar" value="<?php esc_html_e( 'Save Changes', 'gauge' ); ?>" /></p>
