...
<div class="main-first">
		...
		<div class="first_image" style="background:url('<?php bloginfo('template_url'); ?>/images/middle-image.jpg');background-position: center;background-size: cover;background-repeat: no-repeat;">
				<div class="row">
					<div class="first-middle-section">
							...
							<div class="col-xs-12 col-sm-12 col-md-12">
								<h1 class="camera_title"><a href="<?php echo get_permalink($first_product_post_id); ?>"><?php echo $first_product->product_title; ?></a></h1>
							</div>
							<div class="col-xs-12 col-sm-12 col-md-12">
								 <span class="inner-thumnbail-new">
								 <?php echo get_avatar( $wp_post_info_first->user_id ); ?> 
								<!--	<img src="https://keenthemes.com/metronic/preview/demo12/assets/media/users/300_25.jpg"> -->
								<?php echo ucfirst($wp_post_info_first->user_login); ?></span>
								<span class="date-new"><?php echo get_the_date("F j, Y", $first_product_post_id); ?></span>
							</div>
					</div>
	...
	<div class="col-xs-12 col-sm-12 col-md-12">
	<h1 class="camera_title_new"><a href="<?php echo get_permalink($second_product_post_id); ?>"><?php echo $second_product->product_title; ?></a></h1>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-12">
	<span class="inner-thumnbail-new">
			<?php echo get_avatar( $wp_post_info_second->user_id ); ?> 
			<!--	<img src="https://keenthemes.com/metronic/preview/demo12/assets/media/users/300_25.jpg"> -->
			<?php echo ucfirst($wp_post_info_second->user_login); ?></span>
	</span>
	<span class="date-new"><?php echo get_the_date("F j, Y", $second_product_post_id); ?></span>
	</div>
	</div>
	...
	<h1 class="camera_title_new">
		<a href="<?php  echo get_permalink($third_product_post_id);?>"><?php  echo $third_product->product_title; ?></a></h1>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-12">
	<span class="inner-thumnbail-new">
			<?php echo get_avatar( $wp_post_info_thrid->user_id ); ?> 
			<!--	<img src="https://keenthemes.com/metronic/preview/demo12/assets/media/users/300_25.jpg"> -->
			<?php echo ucfirst($wp_post_info_thrid->user_login); ?></span>
	</span>
	<span class="date-new"><?php echo get_the_date("F j, Y", $third_product_post_id); ?></span>
	</div>
	</div>
